...
const Highrise = () => {
  ...
  ReactGA.pageview("/markets/high-rise");
  return (
    <>
      <PageWrapper
        headerConfig={{
      ...
      >
        ...
        <Container>
          <p className="mt-8">
            High-rise construction can present many logistic challenges to the
        ...
        <Container>
          <Row className="justify-content-center mt-11 mb-11 ml-12">
            <Col xl="6" lg="6" sm="6">
              <h4>High-Rise & Mixed-Use Expertise</h4>
              <ul>
            ...
            <Col xl="6" lg="6" sm="6">
              ...
              <ul>
                <li>First & Mission / Oceanwide Center</li>
                <li>The Avery / Transbay Block 8</li>
