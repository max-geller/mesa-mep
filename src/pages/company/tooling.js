                      ...
                      <div className="single-widget my-7 media">
                        ...
                        <div className="media-body">
                          ...
                          <p>
                            ...
                            and techniques as our construction counterparts.
                            Let's have a look:
                          </p>
                          <ul>
                    ...
                    >
                      <div className="single-widget my-7 media">
                        ...
                        <div className="media-body">
                          ...
                          <p>
                            Tired of looking at endless spreadsheets? We are
                            too. Let's show you how we can bring insights into
                            your estimates and historical costs using some
                      ...
                      <div className="single-widget my-7 media">
                        ...
                        <div className="media-body">
                          ...
                          <p>
                            ...
                            changing, but we're pretty good at keeping up. Let
                            us integrate with your existing systems of record
                    ...
                    >
                      <div className="single-widget my-7 media">
                        ...
                        <div className="media-body">
                          ...
                          <p>
                            Design collaboration and review can be a crucial
                            step in understanding cost contributors. Our team is
                      ...
                      <div className="single-widget my-7 media">
                        ...
                        <div className="media-body">
                          ...
                          <p>
                            ...
                            haven't seen before in this industry. Presidio has
                            you covered. We're equipped to deliver insights
                            anywhere in the world, whether in-person or via
                            remote services. Let's take a look:
                          </p>
                          <ul>
