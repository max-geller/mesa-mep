...
import tier2 from "./../../../assets/image/examples/tier2-estimate.png";
      ...
      >
          ...
          <Row className="justify-content-center mt-11 mb-11">
            <Col xl="6" lg="6" sm="11" xs="11">
              <p className="gr-text-8  px-xl-0">
                As design-builders, there is seldom enough margin on projects to
                warrant a dedicated electrical estimator on a full-time basis.
                We're here to help.
              </p>
              <p>
                Accurate MEP estimating requires thoughtful attention to project
                requirements, system experience, familiarity with local Code,
                and regional market pricing insights. It's tough for today's
                owners, developers and general contractors to navigate the
                changing technologies and regulations.
              </p>
              <p>
                General contractors are faced with a continually fluctuating
                market which makes it frustrating to maintain reliable and
                consistent workloads throughout the year. In today’s environment
                of economic pullback, the construction trades are seeing major
                cuts and contractors must do more with less. The contracting
                industry as whole has always been subject to the whims of
                commodity cost changes, local market conditions, and the
                never-ending cycle of subcontractors; but with the current
                resources, lack of training, and dwindling labor pool, recovery
                in the construction sector may take years.
              </p>
            </Col>
            <Col xs="12" lg="6">
              <div className="banner-fluid-image pt-lg-9">
                <img src={tier2} alt="" className="w-100" />
              </div>
            </Col>
        ...
        <Container>
          <Row className="justify-content-center">
            <Col xl="12" lg="12" sm="12">
              <div className="section-title text-center mb-12 mb-lg-17">
                <h2 className="title gr-text-4 mb-7">Solutions at a Glance:</h2>
              </div>
            </Col>
          </Row>
          ...
          <Row className="align-items-center">
            ...
            <Col md="6" lg="6" data-aos="fade-left" data-aos-duration="750">
              <div className="single-widget my-7 media">
                <div className="media-icon circle-sm gr-bg-blue-opacity-1 mr-8">
                  <span className="count text-primary--light-only gr-text-9">
                    3
            ...
            <Col md="6" lg="6" data-aos="fade-left" data-aos-duration="1800">
              <div className="single-widget my-7 media">
                <div className="media-icon circle-sm gr-bg-blue-opacity-1 mr-8">
                  <span className="count text-primary--light-only gr-text-9">
                    4
