...
const RFQ = () => {
  ...
  ReactGA.pageview("/solutions/trades/rfq");
  return (
    <>
      <PageWrapper
        headerConfig={{
              ...
              >
                <div className="hero-content section-title dark-mode-texts">
                  ...
                  <p className="gr-text-8 pr-sm-7 pr-md-12">
                    Seasonal estimating demands can vary widely. We're happy to
                    help manage your Requests-for-Quotations (RFQ) requests from
